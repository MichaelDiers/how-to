...
/// <summary>
///     Tests for <see cref="AesHowTo" />: Encrypt and decrypt data using <see cref="Aes" />.
/// </summary>
public class AesTests
{
    ...
    /// <summary>
    ///     The <see cref="AesHowTo" /> provides operations for encrypting and decrypting data using <see cref="Aes" />.
    /// </summary>
    private readonly AesHowTo aesHowTo = new();
    ...
    public async Task EncryptAsync(int keySize, int dataSize)
    {
        ...
        // encrypt
        var encrypted = await this.aesHowTo.EncryptAsync(
            aes.Key,
            data,
    ...
    public async Task EncryptDecryptAsync(int keySize, int dataSize)
    {
        ...
        // decrypt
        var decrypted = await this.aesHowTo.DecryptAsync(
            aes.Key,
            encrypted,
            TestContext.Current.CancellationToken);
